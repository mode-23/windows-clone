    ...
    <div className={close ? "playlistQue closed" : "playlistQue"}>
      <header className="que_header">
        ...
        <div className="df">
          ...
          <span>
            {" "}
            {+mapIndex + 1} / {data?.meta?.videoCount}
          </span>
        </div>
        <div className="jcs">
          <div className="df">
            <div
              className={
                Videostate === "shuffle"
                  ? "toolholder icon_1 icon_3 active"
                  : "icon_1 icon_3 toolholder"
              }
              onClick={() => {
            ...
            >
              <IoShuffleSharp />
              {Videostate === "shuffle" && (
                <Tooltip direction={"top"} message={`Next ${+randomKey + 1}`} />
              )}
            </div>
            <div
              className={
                Videostate === "loop" ? "icon_1 icon_3 active" : "icon_1 icon_3"
              }
              onClick={() => {
                if (Videostate !== "loop") {
                  setVideoState("loop");
