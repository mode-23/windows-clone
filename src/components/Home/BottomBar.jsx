  ...
  return (
    <div className="bottom_bar">
      {open && (
        <BottomBarMenu
          isOpen={isOpen}
          windBtnRef={windBtnRef}
          isOpenWeather={isOpenWeather}
        />
      )}
      <div
        className={open ? "windowsIcon active" : "windowsIcon"}
        onClick={() => isOpen(!open)}
        ref={windBtnRef}
      >
        <BsWindows />
      ...
      {openMessage && (
        <GmailNotifications user={user} setData={setData} data={data} />
      )}
      <div className="windows_inner_right">
        ...
        <div
          className={
            openMessage
              ? "messages_bottom_bar_icon bottom_bar_icon active"
              : "messages_bottom_bar_icon bottom_bar_icon"
          }
          onClick={() => isOpenMessage(!openMessage)}
        >
          {openMessage ? <BsChatSquareFill /> : <BsChatSquare />}
        </div>
      </div>
    </div>
  );
