    ...
    <div className="df">
     ...
     <div className="doc_title">
      <div className="df">
        ...
        <div className="asc">
          <div className="df">
          <input type="text" defaultValue={data?.file_name} onChange={updateFileName} />
          <div className={!data?.favourite || data?.favourite == "false" ? "doc_title_icon" : "doc_title_icon active"} title='Star' onClick={HandleFavourise}>
          ...
          <div className="doc_title_icon" title={isSaved ? "All changes are saved" : "Saving to office"}>
            {isSaved ? 
            <BsCloudCheck />
            :
        ...
        <small className="doc_title_tab" onClick={() => navigate('/office')}>
               home
          </small> 
          <small className="doc_title_tab" onClick={save}>
               save
          </small>
          <small className="doc_title_tab">
               edit
          </small>
        </div>
        </div>
